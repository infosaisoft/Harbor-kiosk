...
public class HospitalController {
	...
	public String hospitalRegistation(Map<String, Object> map,
			@Valid @ModelAttribute("register-hospital") HospitalCommand hcmd,BindingResult error, HttpServletRequest req,RedirectAttributes redirectattribute) {
		String result = null;
